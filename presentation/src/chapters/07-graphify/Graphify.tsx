      ...
      return (
        <svg viewBox="0 0 80 80" className="gf-mod-svg">
          <rect
            ...
            height="52"
            rx="2"
            className="gf-mod-frame"
          />
          <text x="40" y="50" textAnchor="middle" className="gf-mod-text">
            &lt;/&gt;
          </text>
        </svg>
      );
    ...
    case "image":
      return (
        <svg viewBox="0 0 80 80" className="gf-mod-svg">
          ...
          <polyline
            points="14,56 30,38 46,52 60,32 70,56"
            className="gf-mod-line"
            fill="none"
          />
        </svg>
      );
      ...
      return (
        <svg viewBox="0 0 80 80" className="gf-mod-svg">
          ...
          <text
            ...
            y="50"
            textAnchor="middle"
            className="gf-mod-text gf-mod-text-sm"
          >
            PDF
          </text>
        </svg>
    ...
    case "board":
      return (
        <svg viewBox="0 0 80 80" className="gf-mod-svg">
          ...
          />
          <path
            d="M 16 50 Q 28 32, 40 44 T 64 38"
            className="gf-mod-line"
            fill="none"
          />
        </svg>
...
//           x2="226"
//           y2="40"
//           className={`gf-spec-line gf-line-${kind}`}
//         />
//         {kind === "ambiguous" && (
...
//         kind="extracted"
//         label="EXTRACTED"
//         desc="read it from the source"
//       />
//       <EdgeSpec
//         kind="inferred"
//         label="INFERRED"
//         desc="model-derived, cross-document"
//       />
//       <EdgeSpec
//         kind="ambiguous"
//         label="AMBIGUOUS"
//         desc="flagged so you can audit it"
//       />
//     </div>
//   );
// }
        ...
        <div className="gf-step2">
          ...
          <div className="gf-pipeline">
            {stages.map((s, i) => (
              <div
                key={s}
                className="gf-pipe-cell"
                style={{ animationDelay: `${i * 280}ms` }}
              >
                <div className="gf-pipe-i">
    ...
    <div className="gf-scene scene-pad">
      <div className="gf-step7">
        <div className="gf-split gf-split-left">
          ...
          <div className="gf-split-aside">for code you've just opened</div>
        </div>
        ...
        <div className="gf-split gf-split-right">
          ...
          <div className="gf-split-aside">for code you've inherited</div>
        </div>
      </div>
    </div>
  );
